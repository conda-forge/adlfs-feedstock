About adlfs-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adlfs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10021&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adlfs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adlfs` can be installed with `conda`:
...
It is possible to list all of the versions of `adlfs` available on your platform with `conda`:
...
```
mamba search adlfs --channel conda-forge
```
...
mamba repoquery search adlfs --channel conda-forge

# List packages depending on `adlfs`:
mamba repoquery whoneeds adlfs --channel conda-forge

# List dependencies of `adlfs`:
mamba repoquery depends adlfs --channel conda-forge
```
